...
#     def __init__(self, source, target, cfg, source2=None):
#         self.source = source
...
#         if self.rcs_enabled:
#             if self.source2:
#                 idx_temp = idx // len(self.target)
#                 if idx_temp < len(self.source):
#                     return self.get_rare_class_sample()
#                 else:
#                     s1 = self.source2[idx_temp - len(self.source)]
#                     s2 = self.target[idx % len(self.target)]
#                     s1, s2 = self.synchronized_crop(s1, s2)
#                     out = {
#                         **s1, 'target_img_metas': s2['img_metas'],
...
#         if self.source2:
#             return (len(self.source) + len(self.source2)) * len(self.target)
#         else:
#             return len(self.source) * len(self.target)